...
# Be sure to imoprt our other modules
# so we can have acces to them
import phonebook_main
import phonebook_gui

def center_window(self, w, h): # pass in the tkinter frame (master) reference amd the w and h
...
# catch if the user's clicks on the windows upper-right 'X' ot ensure they want to close
def ask_quit(self):
...
def addToList(self):
    ...
    # normalize the data to keep consistent with db
